...
var queryFactory = (args, query) => css5`
  ${query} {
    ${css5(...args)}
  }
`;
...
init_global_inject();
import {oneOf as oneOf3, bool} from "prop-types";
...
`;
Icon.propTypes = {
  size: oneOf3(["small", "default", "large", "x-large"]),
  inline: bool
};
Icon.defaultProps = {
  size: "default",
...
init_global_inject();
import styled5, {keyframes} from "styled-components";
var rotate = keyframes`
  100% {
    transform:rotate(360deg);
  }
`;
var StyledSvg = styled5.svg`
...
// src/components/Spinner/index.js
var Spinner = ({...props}) => /* @__PURE__ */ React4.createElement(StyledSvg, {
  viewBox: "0 0 24 24",
...
init_global_inject();
import React11, {useRef as useRef2, useEffect as useEffect2, useContext, useReducer} from "react";
import {node as node3, string as string4} from "prop-types";
...
import {object as object2, instanceOf, func as func3} from "prop-types";

// src/components/Toaster/ToastAlert.js
init_global_inject();
import React9, {useState, useEffect, useRef} from "react";
import {func as func2, node as node2, string as string3, oneOf as oneOf4} from "prop-types";
...
var TransitionGroupContext_default = React5.createContext(null);
...
var Transition = /* @__PURE__ */ function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /* @__PURE__ */ React6.createElement(TransitionGroupContext_default.Provider, {
      value: null
    }, typeof children === "function" ? children(status, childProps) : React6.cloneElement(React6.Children.only(children), childProps));
  };
  return Transition2;
}(React6.Component);
...
var CSSTransition = /* @__PURE__ */ function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /* @__PURE__ */ React7.createElement(Transition_default, _extends({}, props, {
...
import {string as string2, object, number} from "prop-types";
...
init_global_inject();
import styled6, {createGlobalStyle as createGlobalStyle2} from "styled-components";
...
var ToastAlert = ({mapKey, removeToast, children, ...props}) => {
  ...
  return /* @__PURE__ */ React9.createElement(CSSTransition_default, {
    in: transitionState === "show",
    timeout: transitionInSpeed,
    classNames: "show"
  }, /* @__PURE__ */ React9.createElement(CSSTransition_default, {
    in: transitionState === "hide",
    timeout: transitionOutSpeed,
    classNames: "hide"
  }, /* @__PURE__ */ React9.createElement(AlertWrapper, {
    transitionInSpeed,
    transitionOutSpeed,
    onMouseEnter: pauseTimer,
    onMouseLeave: startTimer
  }, /* @__PURE__ */ React9.createElement(CloseButton, {
    onClick: dismiss,
    role: "button"
  }, /* @__PURE__ */ React9.createElement(CloseIcon_default, {
    size: 20
  })), /* @__PURE__ */ React9.createElement(Alert_default, {
    ...props
  }, children))));
};
ToastAlert.propTypes = {
  mapKey: string3.isRequired,
  removeToast: func2.isRequired,
  children: node2,
  variant: oneOf4(["info", "warning", "success", "error"])
};
...
var ToastPortal = ({refToasterRoot, toastMap, onRemoveToast}) => {
  return refToasterRoot.current && (0, import_react_dom2.createPortal)(/* @__PURE__ */ React10.createElement(React10.Fragment, null, [...toastMap.entries()].map(([key, toast]) => /* @__PURE__ */ React10.createElement(ToastAlert_default, {
    key,
    mapKey: key,
...
var ToasterProvider = ({rootSelector, children}) => {
  ...
  return /* @__PURE__ */ React11.createElement(ToasterContext.Provider, {
    value: {showToast}
  }, /* @__PURE__ */ React11.createElement(ToasterRootStyle, null), /* @__PURE__ */ React11.createElement(ToastPortal_default, {
    refToasterRoot,
    toastMap,
